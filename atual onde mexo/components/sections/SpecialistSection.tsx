...
const SpecialistSection: React.FC = () => {
  ...
  return (
    <section id="especialista" className="py-24 bg-[#0A0A0A] relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-braz-pink/5 -skew-x-12 transform origin-top-right z-0"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-2 border-braz-pink/20 w-full max-w-md lg:max-w-lg mx-auto">
              <OptimizedImage 
          ...
          >
            <div>
                <h3 className="text-braz-pink text-xl font-bold uppercase tracking-widest mb-2 font-montserrat">A Especialista</h3>
                <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 font-montserrat tracking-tight">
                    {BUSINESS_INFO.owner}
                </h2>
                <div className="w-24 h-1.5 bg-braz-pink rounded-full mb-8 mx-auto md:mx-0"></div>
            </div>
            ...
            <ul className="space-y-4 pt-4 font-montserrat inline-block text-left">
              {highlights.map((item, index) => (
                ...
                >
                  <CheckCircle2 className="text-braz-pink mr-3 flex-shrink-0" size={24} />
                  {item}
                </motion.li>
              ))}
            </ul>
            ...
            <div className="pt-8 font-montserrat">
              <button 
                ...
                className="bg-transparent border-2 border-braz-pink text-braz-pink px-8 py-3 text-lg font-bold uppercase tracking-widest hover:bg-braz-pink hover:text-braz-black transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-braz-pink/30 rounded-sm"
              >
