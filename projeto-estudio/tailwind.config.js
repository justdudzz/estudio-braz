...
export default {
  ...
  theme: {
    extend: {
      // Injeção Direta da Proporção Áurea (φ ≈ 1.618)
      spacing: {
      ...
      // Estética de Luxo: Peso Black para títulos de impacto
      fontWeight: {
        'luxury': '900',
      },
      borderRadius: {
      ...
      colors: {
        'braz-pink': '#C5A059', // Dourado de Luxo
        'braz-black': '#0A0A0A', 
        'braz-cream': '#F5F5F5',
        'aura-gold': 'rgba(197, 160, 89, 0.1)',
      },
      fontFamily: {
      ...
      animation: {
        ...
        'float': 'translateY 3s ease-in-out infinite',
      }
    },
  },
  plugins: [],
