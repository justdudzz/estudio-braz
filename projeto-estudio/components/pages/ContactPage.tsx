                    ...
                    <div className="bg-[#101010]/80 backdrop-blur-2xl p-8 md:p-12 rounded-[2.5rem] border border-white/5 shadow-[0_0_80px_rgba(0,0,0,0.5)] relative overflow-hidden">
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
                            ...
                            <h3 className="text-[11px] font-black font-montserrat tracking-[0.2em] uppercase text-white mb-6 flex items-center gap-3">
                                <Clock size={16} className="text-braz-gold" /> Horário de Funcionamento
                            </h3>
                        ...
                        <a href={`https://wa.me/${BUSINESS_INFO.whatsapp}?text=${BUSINESS_INFO.whatsappMsg}`} target="_blank" rel="noopener noreferrer"
                            ...
                            <MessageCircle size={20} className="relative z-10" /> <span className="relative z-10">Falar no WhatsApp</span>
                        </a>
                    </div>
                </div>
            </section>
